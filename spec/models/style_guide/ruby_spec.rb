...
def register_email(email:)
  ...
  context "default configuration" do
    it "uses a default configuration for rubocop" do
      ...
      violations_in(code, repository_owner_login: "not_thoughtbot")
  ...
  context "thoughtbot organization PR" do
    ...
    def thoughtbot_violations_in(content)
      violations_in(content, repository_owner_login: "thoughtbot")
    end
  end

  private

  def violations_in(content, config: nil, repository_owner_login: "ralph")
    repo_config = double("RepoConfig", enabled_for?: true, for: config)
    style_guide = StyleGuide::Ruby.new(repo_config, repository_owner_login)
